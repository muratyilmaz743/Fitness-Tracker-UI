          ...
          <div className="container-md h-screen bg-gradient-to-r from-cyan-50 to-blue-50 rounded-3xl">
            <div className="text-left border-black-500 p-4 w-full">
              ...
              <div className="flex flex-row overflow-auto">
                <Workout name={"Şınav"} notes={"3 x 10, 45sn dinlenme ile"} />
                <Workout
                  name={"Bench Press"}
            ...
            <div className="text-left border-indigo-500 p-4 w-full">
              ...
              <div className="flex flex-row overflow-auto">
                <Meal
                  name={"Kahvaltı"}
                  notes={
                    "1 dilim az yağlı, az tuzlu peynir (Mümkünse ev yapımı 2 yemek kaşığı lor peyniri), 2 adet haşlanmış yumurta"
                  }
                />
                <Meal
                  name={"Ara öğün"}
                  notes={
                    "1 bardak yağsız süt ya da şekersiz bitki çayı, 2 adet ceviz içi"
                  }
                />
                <Meal
                  name={"Öğle Yemeği"}
                  notes={
                    "8-9 yemek kaşığı sebze yemeği, 3 yemek kaşığı yoğurt, 2 dilim tahıllı ekmek ya da 8 kaşık yağsız tuzsuz makarna veya pilav"
                  }
                />
                <Meal
                  name={"Antrenman Öncesi"}
                  notes={
                    "1 dilim tam tahıllı ekmek, 1 tatlı kaşığı şeker ilavesiz fıstık ezmesi, küçük boy bir yeşil elma"
                  }
                />
                <Meal
                  name={"Akşam Yemeği"}
                  notes={
                    "1 porsiyon az yağlı köfte, et, tavuk ya da balık yemeği, 8-9 yemek kaşığı pilav ya da makarna, 1 kase yoğurt, bol salata"
                  }
                />
              </div>
            </div>

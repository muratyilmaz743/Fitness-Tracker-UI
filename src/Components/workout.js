...
function Workout({ setNumber, repetitionNumber, note, gifUrl, name }) {
  ...
  return (
    <>
      <div className="h-fit w-56 p-4 border-4 border-black m-6 rounded-xl min-w-[14rem]">
        <div class="mb-4 h-full ">
          <p class="text-center bg-blue-200 text-black font-bold py-2 px-4 rounded-full mt-2">
            {name}
          </p>
          <img className="w-full" src={gifUrl} alt="gif of move" />
          <p className="mt-8 ml-4 block">
